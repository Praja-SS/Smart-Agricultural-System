  ...
  <div id="page-container">
      <div id="content-wrap">
        ...
        <div class="section center">
		  ...
		  <img src="irrigation.jpg" style="width:300px;height:200px;">
		 </div>
         <!-- insert content -->
        <p >
          <br>
        Water should enter through the inlet and cover all the channels around the beds. <br>
		Allow the water in the channels to raise till the raised beds are wet and then cut off water. <br>
		The frequency of irrigation is adjusted according to the soil type.<br>
		</p>
		<br>
		<br>
