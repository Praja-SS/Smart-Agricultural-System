    ...
    <div class="content">
      <div id="content-wrap">
        ...
        <p >
          <br>
          <br>
        Plant starts yielding by 70days after transplantation. <br>
        Harvesting is done depending upon purpose like for fresh market, long distance transport etc. <br>
        Mature green tomatoes are harvested for long distance markets.<br>
        Almost all fruits turn into pink or red color.</p>
		<br>
		<br>
</div>
</div>
