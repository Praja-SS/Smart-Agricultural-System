    ...
    <div class="content">
      <div id="content-wrap">
        ...
        <div class="section center">
          <h3 class="center">BRINJAL</h3><br>
		  <img class="responsive-img" src="brinjal.jpg" style="width:300px;height:200px;">
		 </div>
         <!-- insert content -->
        <p>
          <br>
          <b>Introduction:</b><br>
                Brinjal is one of the most common and popular vegetable crops grown in Northeast India. It can be grown in almost all parts of this region round the year except in high altitudes. A large number of cultivars differing in size, shape and colour of fruits are grown in India. Immature fruits are used in curries and a variety of dishes are prepared out of brinjal. Fruits are moderate sources of vitamins and minerals like phosphorous, calcium and iron and nutritive value varies from variety to variety.<br><br>
	         <b>Climate and Soil:</b><br>
                Brinjal can be grown on all kind of soils; generally well drained silt loam and clay loam soils are preferred. It is a warm season crop and susceptible to severe frost. Climatic conditions especially
                low temperature during the cool season is desirable for successful brinjal production. The soil and climatic conditions of this region is highly suitable for cultivation of brinjal. <br><br>
            <b>Yield:</b><br>
                Varieties:25 to 30 t/ha<br>
                Hybrids:60 - 80 t/ha<br><br>
            <b>Plant Protection:</b><br>
                <i>Damping off:</i> Treat the seeds with Trichoderma viride 4 g/kg or Pseudomonas fluorescens 10 g /kg of seed 24 hours before sowing. Apply Pseudomonas fluorescens as soil application @ 2.5 kg/ha mixed with 50 kg of FYM.  Water stagnation should be avoided. Drench with Copper oxychloride at 2.5 g/lit at 4 lit/sq.m<br>
                <i>Leaf Spot:</i> Leaf spot can be controlled by spraying Mancozeb 2 g/lit.<br>
                <i>Little Leaf:</i> Remove the affected plants in the early stages and spray Methyl demeton 30 EC @ 1.0 ml/lit. to control the vector.<br><br>
            <b>Market Information:</b><br>
                Crop Growing districts  : Vellore, Salem, Krishnagiri, Dindigul, Coimbatore<br>
                Major markets in Tamil Nadu : Ottanchatram, Dindigul, Tirunelveli, Tuticorin and Nagercoil<br>
		</p>
  </div>
  </div>
