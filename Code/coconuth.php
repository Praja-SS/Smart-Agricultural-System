  ...
  <div id="page-container">
    <div class="content">
      <div id="content-wrap">
        ...
        <p>
          <br>
        The methods of harvesting coconuts vary from country to country, sometimes even among provinces within the same country. Nevertheless, the two most common methods of harvesting coconuts are the pole and climbing methods. In others like Papua New Guinea, the coconuts are left to fall to the ground and collected thereafter.<br>
        <b>Harvesting with a pole:</b> 
        For the pole method, farmers use a harvesting scythe at the end of a long bamboo pole to cut the coconut bunch, which is left to drop from the palm. The advantage of this method is that it is generally faster, more efficient, less tedious and dangerous compared to the climbing method. This way, the harvester can harvest more nuts per unit time from a larger number of trees. In some coconut plantations, drains are dug out in between the rows of coconut palms, so the coconuts drop into the body of water which cushions the falling impact.<br>
        <b>Harvesting by climbing:</b>
        Using the climbing method, the farmer or worker is engaged to climb up the coconut tree, with or without a climbing device. For easy climbing, some coconut trees have grooves carved into their sides. Although this is dangerous, it is very commonly done to harvest coconuts. Palm climbing devices, like the ones adopted in India, lowers the danger imposed on the harvesters.
      </p>
		<br>
		<br>
</div>
