...
<li class="white"><a href="landprep.php" class="waves-effect waves-blue"> Land Peparation</a></li>
 ...
 <li class="white"><a href="index_chat.php" class="waves-effect waves-blue"><i class="material-icons  right style="margin-right:0;">chat</i> Chat Room</a></li>
  ...
  <tr>
    <td>PB 86</td>
    <td>7 years</td>
    <td> Malayasian clone <br> Yield : 1130 kg per ha/year.</td>
	<td><a href=""><img src="pb86.jpg" width="60" height="60"></a></td>
  </tr>
  <tr>
    <td>TJIR - 1</td>
    <td>6 years</td>
    <td>Indonesian clone<br>Yield 930 kg/ha per year, Susceptible to Phytophtora, Oidium and pink disease.</td>
    <td><a href=""><img src="TJIR - 1.jpg" width="60" height="60"></a></td>
  </tr>
  <tr>
    <td>	PRIM-600</td>
    <td>6.5 years</td>
    <td>Developed by Rubber Research Institute of Malaya (RRIM). <br>Yield 1317kg/ha/year, Susceptible to Phytophthora and pink disease.</td>
	<td><a href=""><img src="PRIM-600.jpg" width="60" height="60"></a></td>
  </tr>
