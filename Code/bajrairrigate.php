 ...
 <li class="white"><a href="landprep.php" class="waves-effect waves-blue"><i class="material-icons right style="margin-right:0;">keyboard_arrow_right</i>Land Prepartion</a></li>
  ...
  <div class="content">
      <div id="content-wrap">
        ...
        <p >
          <br>
          Bajra is grown rainfed and crop being drought resistant hardly needs any irrigation, however it is observed that the yield may be significantly increased by irrigating the crop at critical growth stages like maximum tillering, flowering and grain filling stage.
		 <br> Therefore light irrigations and efficient drainage is very essential for bajra production.
		<br></p>
		<br>
		<br>
