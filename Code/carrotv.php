...
<body>
 ...
 <li class="white"><a href="landprep.php" class="waves-effect waves-blue"><i class="material-icons right style="margin-right:0;">keyboard_arrow_right</i>Land Prepartion</a></li>
  ...
  <tr>
    <td>Ooty 1</td>
    <td>100-110</td>
    <td>Resistant to powdery mildew, leaf spot and drought<br> Yield: 49.1 t/ha</td>
	<td><a href="http://agritech.tnau.ac.in/horticulture/horti_TNAU_varieties_vegetablecrops.html#carr"><img src="Ooty1.jpg" width="60" height="60"></a></td>
  </tr>
  <tr>
    <td>Early Nantes</td>
    <td>62</td>
    <td>Tapered stump<br>Virtually coreless with good texture, colour and flavour</td>
  <td><a href="https://www.simplyseed.co.uk/carrot-seeds/early-nantes.html"><img src="earlynantas.jpg" width="60" height="60"></a></td>
  </tr>

  <tr>
    <td>Pusa Kesar</td>
    <td>90-110</td>
    <td>It has red-coloured roots and self-coloured core.<br>Yield: 30 t/ha.</td>
	<td><a href="http://nhb.gov.in/pdf/vegetable/carrot/car012.pdf"><img src="pusakesar.jpg" width="60" height="60"></a></td>
  </tr>
  <tr>
    <td>Half Long Danvers</td>
    <td>75</td>
    <td>Nearly coreless<br>Yield:  100 pounds/100 foot row</td>
  <td><a href="https://www.gurneys.com/product/danvers_half_long_carrot"><img src="danvers.jpg" width="60" height="60"></a></td>
  </tr>
