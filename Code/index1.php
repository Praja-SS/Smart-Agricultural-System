  ...
  <div class="content">
      <div id="content-wrap">
		...
		<section >
			...
			<h2 class="center">Area : <?php echo $rsedit[city]; ?></h2><br><br>
						
                <form method="post" action="fa11.php" name="farmerprofile" >
					...
					<div class="container1">
                      <table class="center">
						    ...
						    <tbody>
						      ...
						      <tr>
						        <td><i class="material-icons yellow-text right">wb_sunny</i><span><strong>HUMIDITY</strong></span> </td>
								<td><?php echo $rsedit[Humidity]; echo " %" ?></td>
						     
					          </tr>
							  <tr>
						        <td ><span><strong>ANNUAL RAINFALL</strong></span><i class="material-icons blue-text right">wb_cloud</i> </td>
								<td><?php echo $rsedit[Annual_rainfall];echo " mm"?></td>
						        
					          </tr>
						      
						      <tr>
						        <td ><i class="material-icons red-text right">title</i><span><strong>TEMPERATURE</strong></span></td>
								<td><?php echo $rsedit[Temperature];echo " C" ?></td>
