...
<li class="white"><a href="landprep.php" class="waves-effect waves-blue"><i class="material-icons right style="margin-right:0;">keyboard_arrow_right</i>Land Prepartion</a></li>
  ...
  <div class="content">
      <div id="content-wrap">
        ...
        <p >
        <br>
          It cannot withstand heavy moisture so apply irrigation only when needed.<br>Number of irrigation and interval of irrigation depend on soil and climatic condition.<br>Flowering and fruit development are most critical stages of water requirement. 
<br>Stagnation of water causes fungal infection.
</p>
		<br>
		<br>
