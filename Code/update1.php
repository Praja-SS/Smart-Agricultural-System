      ...
      <div id="content-wrap">
        <!-- all other page-content -->
          ...
          <section >
			...
			<h2 class="center">Update Farmer Information</h2>
            ...
            <form method="post" action="fa2.php" name="updateprofile" >
				...
				<tbody>
					<tr>
					     <td width="246">Farmer Name </td>
						 <td width="187"><input type="text" name="farmername" id="farmername" value="<?php echo $rsedit[farmername]; ?>" autofocus></td>
					</tr>
					<tr>
					     <td >Address  </td>
					...
					<tr>
					 ...
					 <tr>
						<td >Land Area (in ha) </td>
						<td><input type="number" name="area" id="area" value="<?php echo $rsedit[area]; ?>"></td>
					 </tr>
