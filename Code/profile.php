  ...
  <div class="content">
      <div id="content-wrap">
        ...
        <section >
			  ...
			  <h2 class="center">Farmer Profile</h2>
                ...
                <form method="post" action="fa1.php" name="farmerprofile" >
					...
					<div class="container1">
                      <table class="center">
						    ...
						    <tbody>
						      <tr>
						        <td><i class="material-icons green-text left">account_circle</i><span><strong>Farmer Name</strong></span></td>
								<td><?php echo $rsedit[farmername]; ?></td>  
					          </tr>
						      <tr>
						        <td><i class="material-icons green-text left">location_on</i><span><strong>Address</strong></span> </td>
								<td><?php echo $rsedit[address]; ?></td>
						     
					          </tr>
							  <tr>
						        <td ><i class="material-icons green-text left">domain</i><span><strong>City</strong></span> </td>
								<td><?php echo $rsedit[city]; ?></td>
						        
					          </tr>
						      
						      <tr>
						        <td ><i class="material-icons green-text left">phone</i><span><strong>Phone</strong></span></td>
								<td><?php echo $rsedit[phone]; ?></td>
						        
					          </tr>
						      <tr>
						        <td ><i class="material-icons green-text left">email</i><span><strong>Email ID</strong></span>  </td>
						        <td><?php echo $rsedit[email_id]; ?></td>
					         </tr>
							 <tr>
						        <td ><i class="material-icons green-text left">transform</i><span><strong>Land Area (in ha)</strong></span> </td>
								<td><?php echo $rsedit[area]; ?></td>
