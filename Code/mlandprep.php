  ...
  <div id="page-container">
    <div class="content">
      <div id="content-wrap">
        ...
        <p >
          <br>
          Maize requires a firm and compact seedbed free from stubbles and weed. <br>
			One deep ploughing should be given, followed by two or three harrowings to bring the soil to a fine tilth.<br>
			Add 10-15 tons of FYM or compost before last harrowing and mix thoroughly with harrow. <br>
			A good seedbed for maize should be fine but compact, and free from weeds. <br>
			It is desirable that the previous crop refuse is buried under with a mouldboard plough.<br>
			In due course, two or three ploughings with the wooden plough are given. <br>
			In case the tractor is used, one ploughing followed by a couple of diskings is generally adequate.<be>

For kharif cultivation, it is essential that adequate drainage is provided<br>. 
It may be provided in the form of very shallow surface drains at 40-50 m apart (depending on the slope and the texture of the soil) across the slope and connected to main outlet.
 <br>Shallow drains do not obstruct the movement of the cattle or tractors during cultivation. 
<br> Surface drains should be provided during sowing.<br></p>
		<br>
		<br>
</div>
</div>
