  ...
  <div class="content">
      <div id="content-wrap">
        ...
        <div class="section center">
          <h3 class="center">GREEN GRAM</h3><br>
		  <img class="responsive-img"src="greengram.jpg" style="width:300px;height:200px;">
		 </div>
         <!-- insert content -->
        <p>
          <br>
		  <b>Introduction:</b>
			Green gram also known as moong is one of the main pulse crop of India. It is a rich source of Protein along with fibre and iron. It can be cultivated as Kharif as well as summer crop
			<br><br>
			<b>Land preparation:</b>
		    Green gram also known as moong is one of the main pulse crop of India. It is a rich source of Protein along with fibre and iron. It can be cultivated as Kharif as well as summer crop
		   <br><br>
		   <b>Climate:</b>
		          <br>Temperature:25-30 deg C
                         <br>Sowing Temperature:25-30 deg C
                         <br>Harvesting Temperature:30-35 deg C
			...
			<br><br>
			<b>Sowing:</b>
			<br>Sowing time:July<br>
			 Seed rate:8-9 kg/ha<br>
			 Sowing space:22.5-30 cm <br>
			 Sowing method:For sowing drill/pora/kera methods are used.
			 <br><br>
                       <b>Plant Protection:</b>
                          If pest infestation is observed, take spray of Malathion @ 375ml or Dimethoate @ 250ml or Oxydemeton Methyl @ 250ml/acre.
			<br><br>
			<b>Irrigation:</b>
			Provide irrigation depending upon the climatic conditions.For summer season crop, three to five irrigations are required depending upon soil type and climatic condition. For good yield stop irrigation 55 days after sowing.

			<br><br>
			<b>Harvest:</b>
                         Best time of harvesting when 85% of pods get matured. Do harvesting with sickle. After harvesting carried out threshing. After threshing, seeds are cleaned and dried in the sunshine.
