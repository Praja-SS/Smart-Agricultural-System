 ...
 <li class="white"><a href="index_chat.php" class="waves-effect waves-blue"><i class="material-icons  right style="margin-right:0;">chat</i> Chat Room</a></li>
  ...
  <div class="content">
      <div id="content-wrap">
        ...
        <p >
        <br>
         Tamarind tolerates well to drought conditions, mostly grown as a rainfed fruit crop.<br>
		  Initially first 2 to 3 years assured irrigation is essential for the establishment.<br>
		  During summer, irrigation should be between 7-10 day interval. <br>
		  </p>
		<br>
		<br>
