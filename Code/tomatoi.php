 ...
 <li class="white"><a href="index_chat.php" class="waves-effect waves-blue"><i class="material-icons  right style="margin-right:0;">chat</i> Chat Room</a></li>
  ...
  <div class="content">
      <div id="content-wrap">
        ...
        <p >
        <br>
          Irrigate with interval of 6 to 7days in winter and in summer month, apply with interval of 10-15days depending upon soil moisture.
          Flowering stage is critical for irrigation</p>
		<br>
		<br>
