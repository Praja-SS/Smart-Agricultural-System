 ...
 <li class="white"><a href="index_chat.php" class="waves-effect waves-blue"><i class="material-icons  right style="margin-right:0;">chat</i> Chat Room</a></li>
  ...
  <div class="content">
      <div id="content-wrap">
        ...
        <p >
        <br>
          First irrigation should be given immediately after sowing.<br>
          Irrigation requirement is depending upon the parameters such as climate, soil moisture level, and the variety used. <br>
          Standard irrigation schedule is 5–6 irrigations 30–35, 60–70, 80–90, 100–105 and 110–150 days after sowing.<br>
		<br></p>
		<br>
		<br>
