  ...
  <div class="content">
      <div id="content-wrap">
        ...
        <div class="section center">
          <h3 class="center"> SOWING </h3><br>
		  <img class="responsive-img" src="sow.jpg" style="width:300px;height:200px;">
		 </div>
         <!-- insert content -->
         <p >
          <br>
             <b>Sowing time:</b>Most appropriate time of sowing is middle or last week of July<br>
<b>Seed rate and Spacing:</b>
4-5 kg/ha for drilling method<br>
2.5-3 kg/ha for dibbling method<br>
spacing 40 –45 cm between rows, 10 –15 cm within rows<br>
<b>Seed treatment:</b> The organo-mercurial compound Ceresan, Agrosan should be used @ 2.5-3 kg/ha to control seed borne diseases.
        </p>
		<br>
		<br>
