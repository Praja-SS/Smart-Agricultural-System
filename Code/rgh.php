  ...
  <div id="page-container">
    <div class="content">
      <div id="content-wrap">
        ...
        <p >
        <br>
         when 75-80% pods turn brown and dry, it is right time of harvesting.<br>Delay in harvesting result in damage of seeds.<br>Harvesting can be done manually by cutting stem or by Machine. 
<br>After harvesting keep bundles of plant upright for drying purpose.<br>Grains are removed from plant by threshing or by traditionally i.e beating plants with sticks.
  </p>
		<br>
		<br>
</div>
