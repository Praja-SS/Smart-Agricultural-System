    ...
    <div class="content">
      <div id="content-wrap">
        ...
        <div class="section center">
          <h3 class="center">BAJRA</h3><br>
		  <img class="responsive-img"src="bajra.jpg" style="width:400px;height:200px;">
		 </div>
         <!-- insert content -->
        <p>
          <br>
          <b>Introduction:</b><br>
               Bajara Pearl millet (Pennisetum glaucum) is the most widely grown type of millet. It is grown in Africa and the Indian subcontinent since prehistoric times. It is generally accepted that pearl millet originated in tropical Africa and was subsequently introduced into India.Bajra is highly drought tolerant and can grow well in the areas with a rainfall of 25–75 cm. This is grown as a kharif crop in northern parts and also grown as summer crop in southern part of the country.<br><br>
	         <b>Climate and Soil:</b><br>
                Bajra crop comes up well in warm weather and dry climate. It can withstand drought to a greater extent. The crop is suitable for areas with annual rainfall of 40 – 75 cm. It cannot grow in saturated soils. During vegetative growth of the crop moist weather is useful. The rainfall at flowering time is harmful as it washes off the pollen and results in poor seed setting. The crop does best under conditions of light showers followed by bright sunshine.Pearl millet can be grown on a wide variety of soils. It thrives well in well drained soils having optimum moisture. It is sensitive to water logging and acidic soils. <br><br>
            <b>Yield:</b><br>
                Rainfed: 2500 - 2800 kg/ha<br>
                Irrigated: 3000 - 3500 kg/ha
                <br><br>
            <b>Plant Protection:</b><br>
                <i>Downy Mildew</i>: Symptoms often vary as a result of systemic infection. Leaf symptoms begin as chlorosis at the base and successively higher leaves show progressively greater chlorosis. Infected chlorotic leaf areas can support abundant white asexual sporulation on the lower leaf surface. To manage grow downy mildew resistant varieties CO7, WCC 75, CO(Cu)9, TNAU-Cumbu Hybrid-CO9. Transplanting reduces disease incidence. At the time of planting infected seedlings should be removed.In the direct sown crop, infested plants should be removed up to 45 days of sowing as and when the symptoms are noticed.<br>
                <i>Ergot</i>: Cream to pink mucilaginous droplets of "honeydew" ooze out of infected florets on pearl millet panicles. Within 10 to 15 days, the droplets dry and harden, and dark brown to black sclerotia develop in place of seeds on the panicle. To manage spray any one of the fungicides like Carbendazim 500g or Mancozeb 1000g /ha when 5 - 10% flowers have opened and again at 50% flowering stage.<br><br>
