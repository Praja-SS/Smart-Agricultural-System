...
<li class="white"><a href="landprep.php" class="waves-effect waves-blue"> Land Peparation</a></li>
 ...
 <li class="white"><a href="index_chat.php" class="waves-effect waves-blue"><i class="material-icons  right style="margin-right:0;">chat</i> Chat Room</a></li>
  ...
  <tr>
    ...
    <td>85-90</td>
    <td>High yeilding <br> rust tolerant <br> Yield: 221Q/ha</td>
	<td><a href="http://agritech.tnau.ac.in/agriculture/agri_seasonandvarieties_wheat.html"><img src="cow.jpg" width="60" height="60"></a></td>
  </tr>
  <tr>
    <td> TNAU Samba Wheat COW 2</td>
    <td>110</td>
    <td>high yielding<br>heat and rust tolerant <br> yeild: 377Q/ha </td>
    <td><a href="http://agritech.tnau.ac.in/agriculture/agri_seasonandvarieties_wheat.html"><img src="tanu.jpg" width="60" height="60"></a></td>
  </tr>
