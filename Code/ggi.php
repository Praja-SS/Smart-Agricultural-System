 ...
 <li class="white"><a href="landprep.php" class="waves-effect waves-blue"><i class="material-icons right style="margin-right:0;">keyboard_arrow_right</i>Land Prepartion</a></li>
  ...
  <div id="page-container">
      <div id="content-wrap">
        ...
        <p >
          <br>
          Provide irrigation depending upon the climatic conditions.<br>For summer season crop, three to five irrigations are required depending upon soil type and climatic condition.<br>For good yield stop irrigation 55 days after sowing.
