  ...
  <div id="page-container">
    <div class="content">
      <div id="content-wrap">
        ...
        <p >
        <br>
        Crop can be harvested at 9 to 11 months after planting.<br>
         During tuber maturity, the leaves become yellow and 50 % of leaves become dried and sheds off.<br>
          The soil near the stem base of the stem shows cracking. <br>
          Tubers can be uprooted by using fork or crow bar. </p>
		<br>
		<br>
</div>
</div>
