 ...
 <li class="white"><a href="landprep.php" class="waves-effect waves-blue"><i class="material-icons right style="margin-right:0;">keyboard_arrow_right</i>Land Prepartion</a></li>
  ...
  <div class="content">
      <div id="content-wrap">
        ...
        <p >
        <br>
          After sowing, apply first irrigation, it will help in good germination.<br>
          Depending upon soil type and climate, apply remaining irrigations at interval of 6-7 days in summer and 10-12 days interval in winter month.<br>
          Overall carrot required three to four irrigations.<br>
          Avoid excessive irrigation as it will leads misshape of roots and numerous hair growth.<br>
          Stop irrigation two to three weeks before harvesting.
		<br></p>
		<br>
		<br>
