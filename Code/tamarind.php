  ...
  <div class="content">
      <div id="content-wrap">
        ...
        <div class="section center">
          <h3 class="center">TAMARIND</h3><br>
		  <img class="responsive-img" src="tamarind.jpg" style="width:300px;height:200px;">
		 </div>
         <!-- insert content -->
        <p>
          <br>
		  <b>Introduction:</b>
			he tamarind, a slow-growing, long-lived, massive tree reaches, under favorable conditions, a height of 80 or even 100 ft (24-30 m), and may attain a spread of 40 ft (12 m) and a trunk circumference of 25 ft (7.5 m). It is highly wind-resistant, with strong, supple branches, gracefully drooping at the ends, and has dark-gray, rough, fissured bark.
			<br><br>
			<b>Land preparation:</b>
      In order to provide space and proper medium for development of vigourous and deep tap root system planting should be done in pits of 1 x 1 x 1m size.
            The pits should be dug during summer and filled in with 2 kg single superphosphate at the base and with a mixture of well decomposed Farm yard manure and top soil. 
		   ...
		   <br><br>
		   <b>Climate:</b>
		   Tamarind tree has a acid climatic adaptability and can be grown in humid to dry hot regions. It is very sensitive to frost. The optimum rainfall requirement is 750-1900mm, but can thrive in region with low annual rainfall of 500-750mm.
			<br><br>
			<b>Soil:</b>
			Tamarind prefers deep loamy soil. It thrives in neutral, gritty, clay, even saline soil type. Soil should be well drained. 
			<br><br>
			<b>Sowing:</b>
			<br>Time of sowing:</b> June to November.<br><b>
...
<b>Sowing depth:</b> Sowing depth is two (2) centimetres deep for all the replications in each row. <br>
		  ...
		  During summer, irrigation should be between 7-10 day interval. <br>
			<br><br>
			<b>Harvest:</b>
			Tamarind fruits mature in early summer.They may be left on the tree for as long as 6 months after maturity so that the moisture content will be reduced to 20% or lower. Fruits for immediate processing are often harvested by pulling the pod away from the stalk.
			<br><br>
