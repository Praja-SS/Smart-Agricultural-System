		...
		<table class='center'>
					...
					<td>
                      <div class="alert alert-danger back-widget-set text-center">
                           <i class="large material-icons">add_to_photos</i><br>



                            
                     <a href="addcrop.php"> Add Crops</a>
                        </div>
                    </div>
					</td>
				<td>
                 <div class="col-md-3 col-sm-3 col-xs-6">
                      <div class="alert alert-danger back-widget-set text-center">
                          ...
                          <a href="modifycroprate.php">Modify Crop Rate</a>
                        </div>
                    </div>
				</td><tr><td>
               <div class="col-md-3 col-sm-3 col-xs-6">
                      <div class="alert alert-warning back-widget-set text-center">
                           <i class="large material-icons">cloud</i><br>


                           
                          <a href="updateweather.php">Update Weather</a>
                        </div>
                    </div></td><td>
               <div class="col-md-3 col-sm-3 col-xs-6">
                      <div class="alert alert-danger back-widget-set text-center">
                            <i class="large material-icons">spa</i><br>
                           
                            
                          <a href="addweedicide.php"> Add Weedicide </a>
                        </div>
                    </div>
				</td>
				<tr><td>
