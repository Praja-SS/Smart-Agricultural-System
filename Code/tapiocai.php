 ...
 <li class="white"><a href="index_chat.php" class="waves-effect waves-blue"><i class="material-icons  right style="margin-right:0;">chat</i> Chat Room</a></li>
  ...
  <div class="content">
      <div id="content-wrap">
        ...
        <p >
        <br>
          First irrigation is given at the time of planting.<br>
            Life irrigation is given on the 3rd day followed by once in 7 – 10 days upto 3rd month and once in 20 – 30 days upto 8th month.<br>
            Drip irrigation can be installed and placed the inline laterals at the interval of 1.5 m.</p>
		<br>
		<br>
