  ...
  <div class="content">
      <div id="content-wrap">
		...
		<section >
			...
			<h2 class="center">Add Crop</h2><br><br>
                	...
                	<table border="2">
						<tbody>
						<tr>
							    <th height="32" scope="row" align="right">Crop Name <font color="#FF0000">*</font>    </th>
							    <td><input type="text" name="crop" required></td>
						    </tr>
							 <tr>
							    <th height="32" scope="row" align="right">City<font color="#FF0000">*</font>    </th>
							    <td><input type="text" name="city" required></td>
						    </tr>
							<tr>
							    <th height="32" scope="row" align="right">Harvest days<font color="#FF0000">*</font>    </th>
							    <td><input type="number" name="hd" required></td>
						    </tr>
							<tr>
							    <th height="32" scope="row" align="right">Rate<font color="#FF0000">*</font>    </th>
							    <td><input type="number" name="rate" step="0.01" required></td>
						    </tr>
							<tr>
							    <th height="32" scope="row" align="right">Yield<font color="#FF0000">*</font>    </th>
							    <td><input type="number" name="yield" required></td>
						    </tr>
							
							<tr>
							    <th height="36"  scope="row" align="right">land Preparation<font color="#FF0000">* </font></th>
							    <td><input type="file" name="lp" required></td>
							</tr>
							<tr>
							    <th height="36"  scope="row" align="right">Varieties<font color="#FF0000">* </font></th>
							    <td><input type="file" name="v" required></td>
							</tr>
							<tr>
							    <th height="36"  scope="row" align="right">Sowing<font color="#FF0000">* </font></th>
							    <td><input type="file" name="s" required></td>
							</tr>
							<tr>
							    <th height="36"  scope="row" align="right">Irrigate<font color="#FF0000">* </font></th>
							    <td><input type="file" name="i" required></td>
							</tr>
							<tr>
							    <th height="36"  scope="row" align="right">harvest<font color="#FF0000">* </font></th>
							    <td><input type="file" name="h" required></td>
							</tr>
					...
					<br><br>
					 <center>
                        ...
                        <button type='submit' name='btn_login' class='col s12 btn btn-medium waves-effect waves-light black green-text'>Add Crop</button>
