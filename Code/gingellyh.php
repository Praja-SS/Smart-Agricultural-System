    ...
    <div class="content">
      <div id="content-wrap">
        ...
        <div class="section center">
         ...
         <!-- insert content -->
        <p >
        <br>Sesame is ready for harvesting 90 to 150 days after planting.<br>
          In general, the unbranched varieties mature earlier. The crop must be harvested before the first killing frost to obtain high quality seeds. <br>
          At maturity, leaves and stems tend to change from green to yellow to red in color. The leaves will begin to fall off the plants. <br>
          The shattering and nonshattering types require different harvesting techniques. Caution is recommended to minimize seed damage and loss.<br>
          Shattering sesame varieties are usually swathed green and placed upright in small shocks, about 8 bundles per shock. Tighten the strings on the shocks in 2 or 3 days.<br>
          In 2 weeks the crop will be ready to thresh. Light rains during this time will not seriously damage seed. Sesame should be threshed using a low cylinder speed (450 to 500 rpm).<br>
         Screens may need to be adjusted (1/8 in. round perforations) for the small seed size. Nonshattering types can be combined directly at low cylinder speed.<br>
		 </p>
		<br>
		<br>
</div>
