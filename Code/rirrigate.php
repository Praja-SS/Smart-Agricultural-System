 ...
 <li class="white"><a href="index_chat.php" class="waves-effect waves-blue"><i class="material-icons  right style="margin-right:0;">chat</i> Chat Room</a></li>
  ...
  <div class="content">
      <div id="content-wrap">
        ...
        <p >
        <br>
          Keep field flooded up to two weeks after transplanting.<br>
		  When all water gets infiltrated two day after apply irrigation in field.<br>
		  Depth of standing water should not exceed 10 cm. <br>
		  While doing intercultural and weeding operation, drain out excess water from field and irrigate field after completion of this operations.<br>
		  Stop irrigation about a fortnight before maturity to facilitate easy harvesting.<br>
		  </p>
		<br>
		<br>
