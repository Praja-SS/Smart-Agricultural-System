...
<li class="white"><a href="landprep.php" class="waves-effect waves-blue"> Land Peparation</a></li>
 ...
 <li class="white"><a href="index_chat.php" class="waves-effect waves-blue"><i class="material-icons  right style="margin-right:0;">chat</i> Chat Room</a></li>
  ...
  <tr>
    <td>Pusa Makhmali</td>
    <td>45-60</td>
    <td>Fruits medium long<br>Yield: 8-10 t/ha</td>
  <td><a href="http://eagri.org/eagri50/HORT281/lec06.html"><img src="pusamakhmali.jpg" width="60" height="60"></a></td>
  </tr>

  <tr>
    <td>Parbhani Kranti</td>
    <td>45-60</td>
    <td>It is yellow vein mosaic resistant.<br>Fruits are dark green in colour, smooth, lender and slender</td>
	<td><a href="https://www.safalseedsbiotech.com/okra-seeds.htm"><img src="prabhani.gif" width="60" height="60"></a></td>
  </tr>
  <tr>
    <td>Pusa Sawani</td>
    <td>45-50</td>
    <td>Smooth and dark green fruits having 5 ridges<br>Yield: 12-12.5 t/ha.</td>
  <td><a href="http://ecoursesonline.iasri.res.in/mod/page/view.php?id=97943"><img src="pusasawni.jpg" width="60" height="60"></a></td>
  </tr>
