   ...
   <div class="content">
      <div id="content-wrap">
        ...
        <div class="section center">
          <h3 class="center">TAPIOCA</h3><br>
		  <img class="responsive-img" src="tapioca.jpg" style="width:300px;height:200px;">
		 </div>
         <!-- insert content -->
        <p>
          <br>
          <br>
          <b>Introduction:</b><br>
                Cassava, (Manihot esculenta), also called manioc, mandioca, or yuca, tuberous edible plant of the spurge family (Euphorbiaceae) from the American tropics. It is cultivated throughout the tropical world for its tuberous roots, from which cassava flour, breads, tapioca, a laundry starch, and an alcoholic beverage are derived. Cassava probably was first cultivated by the Maya in Yucatán.<br><br>
	         <b>Climate and Soil:</b><br>
                Any well drained soil preferably red lateritic loam with a pH range of 5.5 -7.0 is best suited for tapioca cultivation. It thrives best in tropical, warm humid climate with well distributed rainfall of over 100 cm per annum. This crop can be cultivated upto an elevation of 1000 m.	<br><br>
            <b>Yield:</b><br>
                Irrigated:  40 - 50 t/ha<br>
                Rainfed:  20 - 25 t/ha<br><br>
            <b>Plant Protection:</b><br>
                <i>Mosaic:</i> Select the planting materials from healthy plants. For the control of white fly vectors, adopt IPM practices mentioned above.<br>
                <i>Cercospora Leaf spot:</i> Cercospora leaf spot can be controlled spraying Mancozeb at 2 g/lit twice at 15 days interval.<br>
                <i>Tuber rot:</i> Avoid water stagnation. Give good drainage facilities. Spot drenching with Copper oxychloride 2.5 g/lit or apply through soil Trichoderma viride @ 2.5 kg/ha as basal and at 3rd and 6th month after planting.<br>
                <i>Iron deficiency:</i> Spray 3 to 4 times Ferrous sulphate 2.5 g/lit on the appearance of deficiency symptom at weekly intervals. Equal quantity of lime should be added for neutralising the solution.<br><br>
            <b>Market Information:</b><br>
                Crop Growing districts  : Salem, Namakkal, Erode, Dharmapuri, Villupuram<br>
                Major markets in Tamil Nadu : Salem, Dharmapuri, Erode<br>
