...
#page-container{
  background-image: url("weedicide.jpg");
  ...
  <div id="page-container">
    <div class="content">
      <div id="content-wrap">
        ...
        <h4 class="center">Weedicide for : <?php echo $rsedit[crop]; ?></h4><br><br>
           ...
           <div class="card black center">
            ...
            <?php
							if(!isset($_SESSION)) { session_start(); }
								...
								if(isset($_SESSION[id]))
								{
								$sql3= "SELECT * FROM ares.weedicide where crop='$rsedit[crop]' ";
                              $qsql3= mysqli_query($con,$sql3);
                              $wc = (mysqli_fetch_array($qsql3));
                              echo "<div class='card-content white-text '>";   
                              echo "<span class='card-title'>Weedicide name:".$wc[weedicide]."</span>";
                              //echo "<span class='card-title'>Weedicide to be used is:</span>.$wc[weedicide].;
                              echo"</div>";
                              echo"<div class='card-action '>";
                              echo" <a href=".$wc[weedicide_pic]."><span class='align-left red-text'>Picture</span></a>";
                              echo "<a href=".$wc[link]."><span class='align-right red-text'>Buy here</span></a>";
                              // echo "<h3>Weedicide to be used is:</h3><br>";
                              // echo $wc[weedicide];
                              // echo "<h3>Purchase here :<h3><br>";
                              // echo "<a href=".$wc[link]."><img src='buynow.jpg'style='width:75px;height:75px;'></a>";
                              // echo "Check out the picture of the product:";
                              // echo "<a href=".$wc[weedicide_pic]."><img src='spray.png'style='width:75px;height:75px;'></a>";
                              echo "</div>";
