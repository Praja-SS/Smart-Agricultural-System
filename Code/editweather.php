      ...
      <div id="content-wrap">
		...
		<section >
			...
			<h2 class="center">Edit Crop</h2><br><br>
						 <form method="post" action="faew.php" name="updateprofile" >
				...
				<tbody>
					<tr>
						 ...
						 <td width="187"><input type="text" name="city" id="city"></td>
					</tr>
					<tr>
					     <td width="246">Humidity </td>
						 <td><input type="number" name="humid" id="humid" ></td>
					</tr>
					<tr>
					     <td width="246">Annual Rainfall </td>
						 <td><input type="number" name="ar" id="ar" ></td>
					</tr>
					<tr>
					     <td width="246">Temperature </td>
