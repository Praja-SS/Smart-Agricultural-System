...
<li class="white"><a href="landprep.php" class="waves-effect waves-blue"><i class="material-icons right style="margin-right:0;">keyboard_arrow_right</i>Land Prepartion</a></li>
  ...
  <tr>
    <td>Cauvery</td>
    <td>6-8 months for cherries to ripen</td>
    <td>35 to 50 fruits per cluster<br>Plants are dwarf, suitable for high density planting <br> Yield – 3000kg/ha</td>
	<td><a href=""><img src="arabica.jpg" width="60" height="60"></a></td>
  </tr>
  <tr>
    <td>Selection –1 R ( S-270 and S-274)</td>
    <td>8-12 months for cherries to ripen</td>
    <td>35 to 50 fruits per cluster<br>Yield:10 q/ha.</td>
    <td><a href=""><img src="robusta.jpg" width="60" height="60"></a></td>
  </tr>
  <tr>
