 ...
 <li class="white"><a href="index_chat.php" class="waves-effect waves-blue"><i class="material-icons  right style="margin-right:0;">chat</i> Chat Room</a></li>
  ...
  <div class="content">
      <div id="content-wrap">
        ...
        <p >
        <br>
          Irrigate at sowing and give life irrigation 7 days after sowing depending on the soil and climatic condition and allow excess water to percolate.<br>
          Give one pre-flowering irrigation (25 days): One at flowering and one or two at pod setting. An irrigation at flowering period is critical.<br>
		  <br></p>
		<br>
		<br>
