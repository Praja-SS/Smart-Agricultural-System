...
<li class="white"><a href="landprep.php" class="waves-effect waves-blue"> Land Peparation</a></li>
 ...
 <li class="white"><a href="index_chat.php" class="waves-effect waves-blue"><i class="material-icons  right style="margin-right:0;">chat</i> Chat Room</a></li>
  ...
  <tr>
    <td>PKM 1</td>
    <td>135</td>
    <td>Fruits are flat round with prominent green shoulder.<br> Yield: 30-35 tonnes/ha</td>
	<td><a href="http://agritech.tnau.ac.in/horticulture/horti_vegetables_tomato.html"><img src="pkm1.jpg" width="60" height="60"></a></td>
  </tr>
  <tr>
    <td>CO.1</td>
    <td>135</td>
    <td>Semi determinate variety<br>Yield: 25 tonnes/ha.</td>
  <td><a href="http://agritech.tnau.ac.in/horticulture/horti_vegetables_tomato.html"><img src="co1.png" width="60" height="60"></a></td>
  </tr>

  <tr>
    <td>CO.2</td>
    <td>145</td>
    <td>Indeterminate variety<br>Yield: 28-30 tonnes/ha</td>
	<td><a href="http://agritech.tnau.ac.in/horticulture/horti_vegetables_tomato.html"><img src="co2.png" width="60" height="60"></a></td>
  </tr>
  <tr>
    <td>TNAU Tomato Hybrid CO 3</td>
    <td>145-150</td>
    <td>Plants semi determinate and suitable for high density planting<br>Yield:  96.2 t/ha </td>
  <td><a href="http://agritech.tnau.ac.in/crop_improvement/variety_released/2010/tomato.pdf"><img src="thco3.jpg" width="60" height="60"></a></td>
  </tr>
