  ...
  <div class="content">
      <div id="content-wrap">
		...
		<section >
			...
			<h2 class="center">Add Weedicide</h2><br><br>
						
                
					<form method="post" action="aw.php">
                	<table border="2">
						<tbody>
						<tr>
							 ...
							 <tr>
							    <th height="32" scope="row" align="right">Weedicide Name      <font color="#FF0000">*</font>    </th>
							    <td><input type="text" name="weedicide" required></td>
						    </tr>
							<tr>
							    <th  scope="row" style="vertical-align:top;" align="right">Product Link</th>
							    <td><textarea name="link" rows="5" cols="48" required></textarea></td>
						    </tr>
							<tr>
					...
					<br><br>
					 <center>
                        ...
                        <button type='submit' name='btn_login' class='col s12 btn btn-medium waves-effect waves-light black green-text'>Add Weedicide</button>
