  ...
  <div id="page-container">
    <div class="content">
      <div id="content-wrap">
        ...
        <p >
        <br>
          Cotton is grown on ridges and furrows. For irrigated cotton the land is given a deep ploughing followed by two harrowings. <br> Ridges and furrows having different spacing for irrigated and rainfed cotton.<br> For irrigated cotton shallow ridges on 90cm spacing should be prepared which helps in irrigation. According to the slope, the length of ridges should be 6-9m. <br>
              </p>
		<br>
		<br>
</div>
