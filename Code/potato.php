  ...
  <div class="content">
      <div id="content-wrap">
        ...
        <div class="section center">
          <h3 class="center">POTATO</h3><br>
		  <img class="responsive-img" src="potato.jpg" style="width:400px;height:200px;">
		 </div>
         <!-- insert content -->
        <p>
          <br>
      ...
      Well pulverized bed should be prepared by ploughing land once up to 20-25 cm deep.Take two or three harrowing after ploughing operation.Soil should be leveled by planking operation for one to two times. Maintain sufficient moisture in soil before sowing.
		   <br><br>
		   <b>Climate:</b>
		   Growing potatoes requires cool climate. Potatoes grow best in temprature of 15-20(°C). Nevertheless, it has the ability to adapt to a wide range of climate conditions.
			...
			<br><br>
			<b>Sowing:</b>
			<br><b>Time of sowing:</b> 25 September to 10 October <br><b>
...
<b>Sowing depth:</b> Cover with about 3 inches of soil
			 <br><br>
			<b>Irrigation:</b>
