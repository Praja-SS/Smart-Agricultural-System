  ...
  <div class="content">
      <div id="content-wrap">
        ...
        <div class="section center">
          <h3 class="center">RED GRAM</h3><br>
		  <img class="responsive-img" src="redgram.jpg" style="width:300px;height:200px;">
		 </div>
         <!-- insert content -->
        <p>
          <br>
		  <b>Introduction:</b>
			Red gram is an important pulse crop in India. It is also known as Pigeonpea, Arhar and Tur. Red gram is mainly cultivated and consumed in developing countries of the world. This crop is widely grown in India. India is the largest producer and consumer of Red gram in the world.
			<br><br>
			<b>Land preparation:</b>
		    Prepared land by taking one deep ploughing followed by two or three times harrowing. Planking should be followed after each ploughing. It cannot withstand in water logging conditions, prepared field in such a way that water stagnation should not take place.

		   <br><br>
		   <b>Climate:</b>
		       can withstand high temperatures but the threshold temperature for germination is 13o C. It can withstand up to 35o to 40o C provided soil moisture is adequate. It needs rainfall ranging from 60cm to 140cm.
			<br><br>
			<b>Soil:</b>
			It is successfully grown in black cotton soils, well drained with a p H ranging from 7.0 - 8.5. Pigeonpea responds well to properly tilled and we ll drained seedbed. 
			<br><br>
			<b>Sowing:</b>
			<br>Sowing time:May<br>
			 Seed rate:8-9kg/ha<br>
			 Sowing space:25-25cm <br>
			 Sowing method:Broadcasting
			 <br><br>
                       <b>Plant Protection:</b>
                          Avoid dense and close planting.Avoid early or late sowing.Regular soil digging cause death of larvae and pupae.
			<br><br>
			<b>Irrigation:</b>
			Three to four week after sowing apply first irrigation. Remaining irrigations are depends upon rainfall intensity. Flower initiation and pod setting stages are the most crucial to drought stress. Therefore, irrigation at these stages is essential for good yield. Avoid excessive irrigation.Do not apply irrigation after mid-September

			<br><br>
			<b>Harvest:</b>
                        When 75-80% pods turn brown and dry, it is right time of harvesting. Delay in harvesting result in damage of seeds. Harvesting can be done manually by cutting stem or by Machine. After harvesting keep bundles of plant upright for drying purpose. Grains are removed from plant by threshing or by traditionally i.e beating plants with sticks.

			<br><br>
                        <b>Market Information:</b>
                        Market survey and government policies with regard to the marketing and international trade in tur, it is forecasted that red gram would fetch a modal price of around Rs. 9000-10,500 per quintal during harvest months.
			<br><br>
