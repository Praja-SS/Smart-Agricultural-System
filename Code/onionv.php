...
<body>
 ...
 <li class="white"><a href="index_chat.php" class="waves-effect waves-blue"><i class="material-icons  right style="margin-right:0;">chat</i> Chat Room</a></li>
  ...
  <tr>
    <td>CO (On) 5</td>
    <td>90 days</td>
    <td>Most commonly grown , medium sized bulbets <br> Yield:18 t/ha.</td>
	<td><a href="https://www.indiamart.com/proddetail/small-onion-seeds-co-5-9341509697.html"><img src="co(on)5.jpg" width="60" height="60"></a></td>
  </tr>
  <tr>
    <td>Arka Bindu</td>
    <td>100 days</td>
    <td>Bulb size 2.5-3.5cm,recommended for export<br>Yield:250q/ha</td>
    <td><a href=""><img src="arka bindu.png" width="60" height="60"></a></td>
  </tr>
  <tr>
    <td>Agrifound Rose</td>
    <td>95-110 days </td>
    <td>A pickling type cultivar, bulbs 2.5-3.5 cm in size<br>Yield:190-200q/ha</td>
	<td><a href=""><img src="agrifound riose.jpg" width="60" height="60"></a></td>
  </tr>
