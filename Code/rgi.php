 ...
 <li class="white"><a href="index_chat.php" class="waves-effect waves-blue"><i class="material-icons  right style="margin-right:0;">chat</i> Chat Room</a></li>
  ...
  <div class="content">
      <div id="content-wrap">
        ...
        <p >
        <br>
          Three to four week after sowing apply first irrigation.<br>Remaining irrigations are depends upon rainfall intensity.<br>
Flower initiation and pod setting stages are the most crucial to drought stress.<br>Therefore, irrigation at these stages is essential for good yield. 
<br>Avoid excessive irrigation.Do not apply irrigation after mid-September.
</p>
		<br>
		<br>
