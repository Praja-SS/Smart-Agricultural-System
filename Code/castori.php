 ...
 <li class="white"><a href="index_chat.php" class="waves-effect waves-blue"><i class="material-icons  right style="margin-right:0;">chat</i> Chat Room</a></li>
  ...
  <div class="content">
      <div id="content-wrap">
        ...
        <p >
        <br>
          Rainfed crops dont need any irrigation.
		  However in irrigated crop, water should be provided weekly twice.  Frequency of irrigation depends on soil type,climate and crop stage.
		<br></p>
		<br>
		<br>
