  ...
  <div id="page-container">
    <div class="content">
      <div id="content-wrap">
        ...
        <p >
        <br>
            Deep summer ploughing with mould board plough soon after rabi crop is harvested and leaving the soil exposed to sun until onset of monsoon is a common practice.<br>
			With the onset of monsoon the land should be ploughed twice by country plough.<br>
			But the soil for grain crop should be pulverised for a fine tilth by harrowing and cross plankings. <br>
			If desired, field should be levelled before sowing so that rainwater may be well distributed throughout the field.<br>
		   </p>
		<br>
		<br>
</div>
