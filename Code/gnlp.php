  ...
  <div id="page-container">
      <div id="content-wrap">
        ...
        <div class="section center">
          <h3 class="center"> LAND PREPARATION</h3>
		 </div>
         <!-- insert content -->
        <p >
          <br>
            Ground nut is grown on flat bed without proper gradation and slope. this causes water logging. To avoid this problem a broad bed and furrow system is suggested. The raised beds should be 1.2m wide and 15cm high with two furrows of 30cm width on either side to drain out excess of water.<br>
