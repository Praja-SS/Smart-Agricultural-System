...
<li class="white"><a href="landprep.php" class="waves-effect waves-blue"> Land Peparation</a></li>
 ...
 <li class="white"><a href="calc1.php" class="waves-effect waves-blue"><i class="material-icons  right style="margin-right:0;">keyboard_arrow_right</i> Crop Calculator</a></li><li class="white"><a href="index_chat.php" class="waves-effect waves-blue"><i class="material-icons  right style="margin-right:0;">chat</i> Chat Room</a></li>
...
<li class="white"><a href="landprep.php" class="waves-effect waves-blue"><i class="material-icons right style="margin-right:0;">keyboard_arrow_right</i>Land Prepartion</a></li>
  ...
  <tr>
    ...
    <td>125/td>
    <td> Suited for Rainfed cultivation<br><br> Yield: 150Q/ha</td>
	<td><a href="http://www.agritech.tnau.ac.in/agriculture/agri_seasonandvarieties_groundnut.html"><img src="tmv8.jpg" width="60" height="60"></a></td>
  </tr>
  <tr>
    <td> TMV - 9</td>
    <td>105</td>
    <td>Dormancy for 20 days<br><br> yeild:  140Q/ha </td>
    <td><a href="http://www.agritech.tnau.ac.in/agriculture/agri_seasonandvarieties_groundnut.html"><img src="tmv9.jpg" width="60" height="60"></a></td>
  </tr>
  <tr>
    <td> TMV - 10</td>
    <td>135</td>
    <td>High yeilding<br>high shelling<br>high oil content <br> yeild:  154Q/ha </td>
    <td><a href="http://www.agritech.tnau.ac.in/agriculture/agri_seasonandvarieties_groundnut.html"><img src="tmv10.jpg" width="60" height="60"></a></td>
  </tr>
  <tr>
    <td> Kaushal</td>
    <td>125</td>
    <td>1-3 seeded pod<br> 71% shelling<br> <br> yeild:  159Q/ha </td>
    <td><a href="http://www.agritech.tnau.ac.in/agriculture/agri_seasonandvarieties_groundnut.html"><img src="kaushal.jpg" width="60" height="60"></a></td>
  </tr>
  <tr>
    <td> M-13</td>
    <td>125</td>
    <td>High yeilding<br> <Br> Large sized pod HPS category prominent reticulation and medium constriction, tolerant to leafspot.</Br> shelling 68%<br>high oil content <br> yeild:  257Q/ha </td>
    <td><a href="http://www.ikisan.com/tg-groundnut-varieties.html"><img src="m13.jpg" width="60" height="60"></a></td>
  </tr>
