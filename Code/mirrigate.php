 ...
 <li class="white"><a href="index_chat.php" class="waves-effect waves-blue"><i class="material-icons  right style="margin-right:0;">chat</i> Chat Room</a></li>
  ...
  <div class="content">
      <div id="content-wrap">
        ...
        <p >
        <br>
         <br> In regions with about 60 cm of well distributed rainfall during the growing season, any additional irrigation is not necessary.
		 <br>Inadequate soil moisture during flowering and poet flowering particularly during the grain filling period will markedly reduce the yield. 
		 <br> During the grain filling period- the most susceptible stage, additional irrigation if needed, should be applied. 
		 <br> The total number of irrigations will depend on the rainfall distribution pattern. 
		 <br> The spring and rabi crops are entirely raised under irrigation; the number of irrigations may, however, vary from 5-10 depending type of the soil and the prevailing temperatures.</p>
		<br>
		<br></p>
		<br>
		<br>
