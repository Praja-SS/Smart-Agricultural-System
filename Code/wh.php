    ...
    <div class="content">
      <div id="content-wrap">
        ...
        <div class="section center">
         ...
         <!-- insert content -->
        <p >
        Harvesting - The wheat crop is harvested after the grains harden and the straw becomes dry and brittle. The harvesting time varies from zone to zone. Rain fed crops reach the harvesting stage much earlier than irrigated crops. However, the yields of rain fed crops are much lower.
         <br> A combine harvester threshes the wheat, crushes the chaff, then blows chaff across the field. The combine loads the threshed wheat onto a trailer while moving <br>
