...
<head>
  ...
  <title>Manure anf Fertiliser</title>
  <style>
  ...
  <div id="page-container">
    <div class="content">
      <div id="content-wrap">
          ...
          <h3 class="center">FERTILISER</h3><br><br>
          <img src="fertilizer.jpg" style="width:400px;height:200px;"><br><br>
        </div>
         ...
         <!-- insert content -->
          ...
          if(!isset($_SESSION)) { session_start(); }
                ...
                if(isset($_SESSION[id]))
                {
                  ...
                  $sq0 = "SELECT Fname,FYM,N,P,K,S FROM ares.fertilizer where Ctype='$rsedit[crop]'  ";
                  $qsq0 = mysqli_query($con,$sq0);
                  $rs0 = mysqli_fetch_array($qsq0);
                }
                 ?>
          <section >
              ...
              <div class="container1">
                <table class="center">
                  <tbody>
                    ...
                    <tr>
                      <td><span><strong><b>CROP</b></strong></span> </td>
                      <td><?php echo $rsedit[crop];  ?></td>
                 
                    </tr>
                    <tr>
                      <td ><span><strong><b>FERTILISER</b></strong></span></td>
                      <td><?php echo $rs0[Fname]; ?></td>
                    </tr>
                  ...
                  {
                    echo "<tr>";
                    echo "<td>","<b>","FERTILISER RATE","</b>","</td>";
                    echo "<td>".$rs0[N]. " : " .$rs0[P]. " : " .$rs0[K]." kg/ha", "</td>";
                    echo "</tr>";
                    echo "<tr>";
                    echo "<td>","<b>","FERTILISER RATE(For your area)","</b>","</td>" ;
                    $n = $rs0[N] * $rsedit[area];
                    $p = $rs0[P] * $rsedit[area];
                    $k = $rs0[K] * $rsedit[area];
                    echo "<td>".$n." : ".$p." : ".$k. " kg" ,"</td>";
                  ...
                  case "NPKS":
                  {
                    echo "<tr>";
                    echo "<td>","<b>","FERTILISER RATE","</b>","</td>";
                    echo "<td>".$rs0[N]. " : " .$rs0[P]. " : " .$rs0[K]." : ".$rs0[S]. " kg/ha","</td>";
                    echo "</tr>";
                    echo "<tr>";
                    echo "<td>","<b>","FERTILISER RATE(For your area)","</b>","</td>" ;
                    $n = $rs0[N] * $rsedit[area];
                    $p = $rs0[P] * $rsedit[area];
                    $k = $rs0[K] * $rsedit[area];
                    echo "<td>".$n." : ".$p." : ".$k." : ".$rs0[S]*$rsedit[area]. " kg" ,"</td>";
                    echo "</tr>";
                  }
                  break;
                  case "NK":
                  ...
                  case "FYM":
                  {
                     echo "<tr>";
                    echo "<td>","<b>","FERTILISER RATE","</b>","</td>";
                    echo "<td>".$rs0[FYM]." t/ha","</td>";
                    echo "</tr>";
                    echo "<tr>";
                    echo "<td>","<b>","FERTILISER RATE(For your area)","</b>","</td>" ;
                    $n = $rs0[FYM] * $rsedit[area];
                    echo "<td>".$n." tonnes" ,"</td>";
                    echo "</tr>";
                  }
                  break;
                  case "NPS":
                  {
                      echo "<tr>";
                    echo "<td>","<b>","FERTILISER RATE","</b>","</td>";
                    echo "<td>".$rs0[N]. " : " .$rs0[P]. " : " .$rs0[S]. " kg/ha","</td>";
                    echo "</tr>";
                    echo "<tr>";
                    echo "<td>","<b>","FERTILISER RATE(For your area)","</b>","</td>" ;
                    $n = $rs0[N] * $rsedit[area];
                  ...
                  case "NPK+FYM":
                  {
                    ...
                    $p = $rs0[P] * $rsedit[area];
                    $k = $rs0[K] * $rsedit[area];
                    echo "<td>".$n." : ".$p." : ".$k. " + ".$rs0[FYM]*$rsedit[area]. " kg" ,"</td>";
                    echo "</tr>";
                  }
