...
<li class="white"><a href="landprep.php" class="waves-effect waves-blue"><i class="material-icons right style="margin-right:0;">keyboard_arrow_right</i>Land Prepartion</a></li>
  ...
  <tr>
    <td> Coeghat green dwarf(CGD)
    </td>
    <td>3 years after planting</td>
    <td>poor quality <br> hard and leathery <br> Yield: 77nuts/palm/year</td>
	<td><a href="http://www.ikisan.com/tn-coconut-varieties.html"><img src="cgd.jpg" width="60" height="60"></a></td>
  </tr>

  <tr>
    <td>Cowghat orange dwarf(COD)</td>
    <td> 4 years after planting</td>
    <td> leaf length is 3.1m <br> yeild: 63nuts/palm/year </td>
    <td><a href="http://www.ikisan.com/tn-coconut-varieties.html"><img src="cod.jpg" width="60" height="60"></a></td>
  </tr>
