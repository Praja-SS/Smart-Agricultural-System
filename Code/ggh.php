  ...
  <div id="page-container">
      <div id="content-wrap">
        ...
        <div class="section center">
		  ...
		  <img src="harvest.jpg" style="width:300px;height:200px;">
		 </div>
         <!-- insert content -->
        <p >
          <br>
         Best time of harvesting when 85% of pods get matured.<br> Do harvesting with sickle.<br> After harvesting carried out threshing.<br> After threshing, seeds are cleaned and dried in the sunshine.
