        ...
        <div class="container">
          <div class="row">
            ...
            <form action="insert1.php" method="POST">
                <table>
                  <tr>
                    <td width="136" height="34" align="right">Farmer Name: <font color="#FF0000">*</font></td>
                    <td width="811"><input type="text" name="farmername" required></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td width="811"><input type="text" name="city" required></td>
                  </tr>
                  <tr>
                    <td height="40" align="right">Phone NO: <font color="#FF0000"> *</font></td>
                    <td>
                    <input type="phone" name="phone" required>  </td>
                  </tr>
                  <tr>
                    <td height="39" align="right">Email ID: <font color="#FF0000"> *</font></td>
                    <td><input type="email_id" name="email_id" required></td>
                  </tr> 
                  <tr>
