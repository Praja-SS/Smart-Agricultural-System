  ...
  <div id="page-container">
    <div class="content">
      <div id="content-wrap">
        ...
        <p >
        <br>
            Prepared land by taking one deep ploughing followed by two or three times harrowing.<br>Planking should be followed after each ploughing.<br>
It cannot withstand in water logging conditions, prepared field in such a way that water stagnation should not take place.
 </p>
		<br>
		<br>
</div>
