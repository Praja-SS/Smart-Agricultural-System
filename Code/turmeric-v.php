...
<body>
 ...
 <li class="white"><a href="index_chat.php" class="waves-effect waves-blue"><i class="material-icons  right style="margin-right:0;">chat</i> Chat Room</a></li>
  ...
  <tr>
    <td>Suguna</td>
    <td>190</td>
    <td>High yield.<br> Reddish yellow coloured rhizome.</td>
	<td><a href="https:www.spices.res.in%2Fpages%2Fsuguna-turmeric&psig=AOvVaw1NFWx0jGWoThEU67tqY98x&ust=1589814598564000&source=images&cd=vfe&ved=0CAIQjRxqFwoTCIDpooWXu-kCFQAAAAAdAAAAABAD"><img src="suguna.jpg" width="60" height="60"></a></td>
  </tr>
  <tr>
    <td>Suvarna</td>
    <td>200</td>
    <td>Yield:17.4 tonnes/ha<br> Deep orange rhizome.</td>
    <td><a href="https://www.spices.res.in%2Fpages%2Fsuvarna-turmeric&psig=AOvVaw3ObChnbX_eriAXlNMu1ywb&ust=1589814033178000&source=images&cd=vfe&ved=0CAIQjRxqFwoTCJizxOOWu-kCFQAAAAAdAAAAABAD"><img src="suverna.jpg" width="60" height="60"></a></td>
  </tr>
  <tr>
    <td>Sudarshana</td>
    <td>190</td>
    <td>High yield at short duration.<br>Thick plumpy rhizome.</td>
	<td><a href="https://https:www.spices.res.in%2Fpages%2Fsudarshana-turmeric&psig=AOvVaw1Zih8BOxNlSVzAgN2YanG9&ust=1589814140502000&source=images&cd=vfe&ved=0CAIQjRxqFwoTCIDqysCWu-kCFQAAAAAdAAAAABAD"><img src="sudarshana.png" width="60" height="60"></a></td>
  </tr>
  <tr>
    <td>Krishna</td>
    <td>240</td>
    <td>Yield:75-80 qt/ha<br>Whitish yellow core with wrinkels.</td>
	<td><a href="https://www.indiamart.com%2Fkrishna-turmeric-finger%2F&psig=AOvVaw1HRYxYYAo4OHQQtUx7QUbh&ust=1589814210615000&source=images&cd=vfe&ved=0CAIQjRxqFwoTCJibl86Vu-kCFQAAAAAdAAAAABAD"><img src="krishna.jpg" width="60" height="60"></a></td>
  </tr>
