    ...
    <div class="content">
      <div id="content-wrap">
        ...
        <p >
          <br>
          <br>
        Brinjal is harvested when the fruit attain proper size, color and before ripening stage.<br>
         The fruit should have glossy appearance, attractive bright color to fetch good prices in the market.
        </p>
		<br>
		<br>
</div>
